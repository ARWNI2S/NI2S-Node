...
namespace NI2S.Node.Tests
{
    public class GzipSecureHostConfigurator : TcpHostConfigurator
    {
        ...
        public override void Configure(INodeHostBuilderOld hostBuilder)
        {
        ...
        public override async ValueTask<Stream> GetClientStream(Socket socket)
        {
            ...
            options.TargetHost = "debug.arwni2s.com";
        ...
        {
            var client = new GZipNodeClient<TPackageInfo>(pipelineFilter, options);
            client.Security = new SecurityOptions
            {
                TargetHost = "debug.arwni2s.com",
