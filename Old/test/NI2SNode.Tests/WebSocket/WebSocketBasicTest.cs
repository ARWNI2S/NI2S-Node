...
namespace NI2S.Node.Tests.WebSocket
{
    ...
    public class WebSocketBasicTest : WebSocketServerTestBase
    {
        ...
        */
        ...
        [InlineData(typeof(RegularHostConfigurator))]
        [InlineData(typeof(SecureHostConfigurator))]
        public async Task TestCommands(Type hostConfiguratorType, Func<INodeHostBuilder<WebSocketPackage>, INodeHostBuilder<WebSocketPackage>> hostBuilderAdapter = null) 
        {
            var hostConfigurator = CreateObject<IHostConfigurator>(hostConfiguratorType);
