...
namespace NI2S.Node.Hosting
{
    ...
    public class ServerHostBuilderAdapter<TReceivePackage> : NodeHostBuilder<TReceivePackage>, IServerHostBuilderAdapter
    {
        private readonly IServiceCollection _currentServices = new ServiceCollection();

        private IServiceProvider _serviceProvider = default!;

        private IServiceProvider _hostServiceProvider = default!;
        ...
        public override NodeHostBuilder<TReceivePackage> ConfigureContainer<TContainerBuilder>(Action<HostBuilderContext, TContainerBuilder> configureDelegate)
        {
            _configureContainerActions.Add(new ConfigureContainerAdapter<TContainerBuilder>(configureDelegate));
            return this;
        }

        public override NodeHostBuilder<TReceivePackage> UseServiceProviderFactory<TContainerBuilder>(IServiceProviderFactory<TContainerBuilder> factory)
        {
        ...
        public override NodeHostBuilder<TReceivePackage> UseServiceProviderFactory<TContainerBuilder>(Func<HostBuilderContext, IServiceProviderFactory<TContainerBuilder>> factory)
        {
            _serviceProviderBuilder = (context, services) =>
            {
