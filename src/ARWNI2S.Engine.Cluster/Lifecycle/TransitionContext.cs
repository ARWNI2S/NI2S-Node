...
internal sealed class TransitionContext : IDeflationContext, IInflationContext, IDisposable, IEnumerable<string>, IBufferWriter<byte>
{
    [NonSerialized]
    ...
    [OrleansConstructor]
    public TransitionContext(SerializerSessionPool sessionPool)
    {
    ...
    private sealed class Enumerator(TransitionContext context) : IEnumerator<string>, IEnumerator
    {
    ...
    {
        public void OnDeserializing(TransitionContext context) => context._sessionPool = serializerSessionPool;
    }
}
