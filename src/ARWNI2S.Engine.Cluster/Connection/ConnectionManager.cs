...
namespace ARWNI2S.Cluster.Connection
{
    ...
    {
        private readonly Action<ClusterNodeConnection> _walkCallback;
        ...
        private readonly ClusterTrace _trace;

        public ConnectionManager(ClusterTrace trace, long? upgradedConnectionLimit)
            : this(trace, GetCounter(upgradedConnectionLimit))
        {
        }

        public ConnectionManager(ClusterTrace trace, ResourceCounter upgradedConnections)
        {
