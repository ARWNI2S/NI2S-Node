...
namespace ARWNI2S.Cluster.Maintenance
{
    ...
    /// Task service
    /// </summary>
    public partial class MaintenanceTaskService : IMaintenanceTaskService
    {
        #region Fields

        protected readonly IRepository<MaintenanceTask> _taskRepository;

        #endregion

        #region Ctor

        public MaintenanceTaskService(IRepository<MaintenanceTask> taskRepository)
        {
        ...
        public virtual async Task DeleteTaskAsync(MaintenanceTask task)
        {
        ...
        /// </returns>
        public virtual async Task<MaintenanceTask> GetTaskByIdAsync(int taskId)
        {
        ...
        /// The task result contains the schedule task
        /// </returns>
        public virtual async Task<MaintenanceTask> GetTaskByTypeAsync(string type)
        {
        ...
        /// </returns>
        public virtual async Task<IList<MaintenanceTask>> GetAllTasksAsync(bool showHidden = false)
        {
            ...
            //        Seconds = 2073600,
            //        Type = "NI2S.Services.Common.ResetLicenseCheckTask, Nop.Services",
            //        Enabled = true,
        ...
        /// </summary>
        /// <param name="task">Task</param>
        public virtual async Task InsertTaskAsync(MaintenanceTask task)
        {
        ...
        /// </summary>
        /// <param name="task">Task</param>
        public virtual async Task UpdateTaskAsync(MaintenanceTask task)
        {
