...
namespace ARWNI2S.Cluster
{
    ...
    public partial class TaskScheduler : ITaskScheduler
    {
        ...
        public TaskScheduler(NI2SSettings appSettings,
        ...
        public async Task InitializeAsync()
        {
            ...
            var scheduleTaskService = scope.ServiceProvider.GetService<IMaintenanceTaskService>() ?? throw new NullReferenceException($"Can't get {nameof(IMaintenanceTaskService)} implementation from the scope");
            ...
            var scheduleTaskUrl = $"{store.Url.TrimEnd('/')}/{MaintenanceDefaults.ScheduleTaskPath}";
            var timeout = _settings.Get<CommonConfig>().ScheduleTaskRunTimeout;
        ...
        protected partial class TaskThread : IDisposable
        {
            ...
            protected readonly MaintenanceTask _scheduleTask;
            ...
            public TaskThread(MaintenanceTask task, string scheduleTaskUrl, int? timeout)
            {
