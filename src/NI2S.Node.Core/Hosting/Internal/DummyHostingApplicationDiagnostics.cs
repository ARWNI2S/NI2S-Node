...
{
    internal sealed class DummyHostingApplicationDiagnostics
    {
        ...
        public DummyHostingApplicationDiagnostics(
            ILogger logger,
        ...
        public void BeginRequest(DummyContext dummyContext, DummyHostingApplication.Context context)
        {
            ...
            if (loggingEnabled || diagnosticListenerActivityCreationEnabled || _activitySource.HasListeners())
            {
                ...
                if (context.Activity is Activity activity)
                {
                    ...
                    {
                        dummyContext.Features.Set(context.HttpActivityFeature);
                    }
                }
            }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public void RequestEnd(DummyContext dummyContext, Exception exception, DummyHostingApplication.Context context)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static void ContextDisposed(DummyHostingApplication.Context context)
        {
            if (context.EventLogEnabled)
            {
                // Non-inline
        ...
        private void LogRequestStarting(DummyHostingApplication.Context context)
        {
            // IsEnabled is checked in the caller, so if we are here just log
            var startLog = new DummyHostingRequestStartingLog(context.DummyContext!);
            ...
            _logger.Log(
                ...
                state: startLog,
                exception: null,
                formatter: DummyHostingRequestStartingLog.Callback);
        }

        [MethodImpl(MethodImplOptions.NoInlining)]
        private void LogRequestFinished(DummyHostingApplication.Context context, long startTimestamp, long currentTimestamp)
        {
            ...
            if (context.StartLog != null)
            {
                ...
                _logger.Log(
                    ...
                    state: new DummyHostingRequestFinishedLog(context, elapsed),
                    exception: null,
                    formatter: DummyHostingRequestFinishedLog.Callback);
            }
        }
        ...
        // https://github.com/dotnet/diagnostics/blob/7cc6fbef613cdfe5ff64393120d59d7a15e98bd6/src/Microsoft.Diagnostics.Monitoring.EventPipe/Configuration/DummyRequestSourceConfiguration.cs#L20-L33
        [DynamicDependency(nameof(DummyContext.Request), typeof(DummyContext))]
        ...
        // DynamicDependency matches the properties selected in:
        // https://github.com/dotnet/diagnostics/blob/7cc6fbef613cdfe5ff64393120d59d7a15e98bd6/src/Microsoft.Diagnostics.Monitoring.EventPipe/Configuration/DummyRequestSourceConfiguration.cs#L35-L38
        [DynamicDependency(nameof(DummyContext.Response), typeof(DummyContext))]
        [DynamicDependency(nameof(DummyResponse.StatusCode), typeof(DummyResponse))]
        ...
        private static class Log
        {
            ...
            private sealed class HostingLogScope : IReadOnlyList<KeyValuePair<string, object>>
            {
                ...
                public HostingLogScope(DummyContext dummyContext)
                {
                    ...
                    _path = (!string.IsNullOrEmpty(dummyContext.Request.PathBase)
