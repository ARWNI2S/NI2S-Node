...
namespace NI2S.Node.Hosting
{
    ...
    {
        public static NI2SNodeHostBuilder UseSomeService(this NI2SNodeHostBuilder hostBuilder, Func<object, ValueTask>? packageHandler, Func<object, Exception, ValueTask<bool>>? errorHandler = null)
        {
            return hostBuilder.ConfigureServices(
                (hostCtx, services) =>
                {
                    if (packageHandler != null)
                        services.AddSingleton<Func<object, ValueTask>>(packageHandler);

                    if (errorHandler != null)
                        services.AddSingleton<Func<object, Exception, ValueTask<bool>>>(errorHandler);
                }
            );
        }
        ...
        //public static INode BuildAsNode(this IHostBuilder hostBuilder)
        //{
        //    var host = hostBuilder.Build();
        //    return host.AsNode();
        //}

        //public static INode AsNode(this IHost host)
        //{
