...
namespace NI2S.Node.Hosting
{
    ...
    public static class HostingAbstractionsNodeHostBuilderExtensions
    {
        ...
        /// </summary>
        /// <param name="hostBuilder">The <see cref="INodeHostBuilder"/> to configure.</param>
        /// <param name="server">The <see cref="IDummyServer"/> to be used.</param>
        /// <returns>The <see cref="INodeHostBuilder"/>.</returns>
        public static INodeHostBuilder UseServer(this INodeHostBuilder hostBuilder, IDummyServer server)
        {
            if (server == null)
            {
        ...
        /// </summary>
        /// <param name="hostBuilder">The <see cref="INodeHostBuilder"/> to configure.</param>
        /// <param name="assetsRoot">Path to the root directory used by the web server.</param>
        /// <returns>The <see cref="INodeHostBuilder"/>.</returns>
        public static INodeHostBuilder UseAssetsRoot(this INodeHostBuilder hostBuilder, string assetsRoot)
        {
            if (assetsRoot == null) throw new ArgumentNullException(nameof(assetsRoot));

            return hostBuilder.UseSetting(NodeHostDefaults.AssetsRootKey, assetsRoot);
        }
