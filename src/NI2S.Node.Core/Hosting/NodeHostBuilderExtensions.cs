...
namespace NI2S.Node.Hosting
{
    ...
    public static class NodeHostBuilderExtensions
    {
        ...
        /// <param name="configureApp">The delegate that configures the <see cref="INodeBuilder"/>.</param>
        /// <returns>The <see cref="INodeHostBuilder"/>.</returns>
        public static INodeHostBuilder Configure(this INodeHostBuilder hostBuilder, Action<INodeBuilder> configureApp)
        {
        ...
        /// <param name="configureApp">The delegate that configures the <see cref="INodeBuilder"/>.</param>
        /// <returns>The <see cref="INodeHostBuilder"/>.</returns>
        public static INodeHostBuilder Configure(this INodeHostBuilder hostBuilder, Action<NodeHostBuilderContext, INodeBuilder> configureApp)
        {
            if (configureApp == null)
            {
                throw new ArgumentNullException(nameof(configureApp));
        ...
        /// <summary>
        /// Configures the <see cref="INodeHostEnvironment.WebRootFileProvider"/> to use static web assets
