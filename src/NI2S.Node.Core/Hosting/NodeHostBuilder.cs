...
namespace NI2S.Node.Hosting
{
    ...
    public class NodeHostBuilder : INodeHostBuilder
    {
        ...
        public NodeHostBuilder()
        {
            ...
            //    UseSetting(NodeHostDefaults.ServerUrlsKey, Environment.GetEnvironmentVariable("NETCORE_SERVER.URLS"));
            //}
        ...
        public INodeHost Build()
        {
            ...
            if (!_options.SuppressStatusMessages)
            {
                ...
                {
                    Console.WriteLine("The environment variable 'Hosting:Environment' is obsolete and has been replaced with 'NETCORE_ENVIRONMENT'");
                }

                if (Environment.GetEnvironmentVariable("ASPNET_ENV") != null)
                {
                    Console.WriteLine("The environment variable 'ASPNET_ENV' is obsolete and has been replaced with 'NETCORE_ENVIRONMENT'");
                }

                if (Environment.GetEnvironmentVariable("NETCORE_SERVER.URLS") != null)
                {
                    Console.WriteLine("The environment variable 'NETCORE_SERVER.URLS' is obsolete and has been replaced with 'NETCORE_URLS'");
                }
            }
        ...
        private IServiceCollection BuildCommonServices(out AggregateException hostingStartupErrors)
        {
            ...
            services.AddTransient<INodeBuilderFactory, NodeBuilderFactory>();
            services.AddTransient<IDummyContextFactory, DefaultDummyContextFactory>();
            services.AddScoped<IDummyMiddlewareFactory, MiddlewareFactory>();
            services.AddOptions();
            services.AddLogging();
