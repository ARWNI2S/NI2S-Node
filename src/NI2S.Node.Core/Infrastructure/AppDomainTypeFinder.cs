...
{
    /// <summary>
    /// A class that finds types needed by NI2S by looping assemblies in the 
    ...
    public class AppDomainTypeFinder : ITypeFinder
    {
        ...
        private string _assemblySkipLoadingPattern = "^System|^mscorlib|^Microsoft|^AjaxControlToolkit|^Antlr3|^Autofac|" +
            "^AutoMapper|^Castle|^ComponentArt|^CppCodeProvider|^DotNetOpenAuth|^EntityFramework|^EPPlus|^FluentValidation|" +
            "^ImageResizer|^itextsharp|^log4net|^MaxMind|^MbUnit|^MiniProfiler|^Mono.Math|^MvcContrib|^Newtonsoft|^NHibernate|" +
            "^nunit|^Org.Mentalis|^PerlRegex|^QuickGraph|^Recaptcha|^Remotion|^RestSharp|^Rhino|^Telerik|^Iesi|^TestDriven|" +
            "^TestFu|^UserAgentStringLibrary|^VJSharpCodeProvider|^WebActivator|^WebDev|^WebGrease";
        ...
        /// <summary>
        /// Gets or sets wether NI2S should iterate assemblies in the app domain when loading NI2S types.
        ...
        /// For ease of use this defaults to match all but to increase performance you
        /// might want to configure a pattern that includes assemblies and your own.
        /// </summary>
        /// <remarks>
        /// If you change this so that NI2S assemblies aren't investigated (e.g. by not
        /// including something like "^NI2S|..." you may break core functionality.
        /// </remarks>
        ...
        public IEnumerable<Type> FindClassesOfType(Type assignTypeFrom, IEnumerable<Assembly> assemblies, bool onlyConcreteClasses = true)
        {
            ...
            catch (ReflectionTypeLoadException ex)
            {
                ...
                foreach (var e in ex.LoaderExceptions)
                    msg += e == null ? string.Empty : e.Message + Environment.NewLine;
        ...
        /// </summary>
        /// <returns>
        /// A list of assemblies that should be loaded by the NI2S factory.
        /// </returns>
        ...
        /// <summary>
        /// Checks if a dll is one of the shipped dlls that we know don't need to be investigated.
        /// </summary>
        /// <param name="assemblyFullName">
        /// The name of the assembly to check.
        /// </param>
        /// <returns>
        /// True if the assembly should be loaded into ni2s.
        /// </returns>
        ...
        protected virtual void LoadMatchingAssemblies(string directoryPath)
        {
            ...
            foreach (string dllPath in Directory.GetFiles(directoryPath, "*.dll"))
            {
                try
                {
                    ...
                    //if (Matches(assembly.FullName) && !loadedAssemblyNames.Contains(assembly.FullName))
                    //{
