...
{
    /// <summary>
    /// Default implementation for <see cref="IDummyFeatureCollection"/>.
    /// </summary>
    public class DummyFeatureCollection : IDummyFeatureCollection
    {
        private static readonly KeyComparer FeatureKeyComparer = new();
        private readonly IDummyFeatureCollection _defaults;
        private readonly int _initialCapacity;
        private IDictionary<Type, object> _features;
        private volatile int _containerRevision;

        /// <summary>
        /// Initializes a new instance of <see cref="DummyFeatureCollection"/>.
        /// </summary>
        public DummyFeatureCollection()
        {
        }

        /// <summary>
        /// Initializes a new instance of <see cref="DummyFeatureCollection"/> with the specified initial capacity.
        /// </summary>
        ...
        public DummyFeatureCollection(int initialCapacity)
        {
        ...
        /// <summary>
        /// Initializes a new instance of <see cref="DummyFeatureCollection"/> with the specified defaults.
        /// </summary>
        /// <param name="defaults">The feature defaults.</param>
        public DummyFeatureCollection(IDummyFeatureCollection defaults)
        {
            _defaults = defaults;
        }
