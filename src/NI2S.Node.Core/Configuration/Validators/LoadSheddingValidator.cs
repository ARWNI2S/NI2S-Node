...
namespace NI2S.Node.Configuration.Validators
{
    /// <summary>
    ...
    internal class LoadSheddingValidator : IConfigurationValidator
    {
        ...
        public void ValidateConfiguration()
        {
            ...
            {
                throw new NI2SConfigurationException(InvalidLoadSheddingLimit);
            }
            ...
            {
                throw new NI2SConfigurationException(HostEnvironmentStatisticsNotConfigured);
            }
        }
    }
}
