...
namespace ARWNI2S.Services.Clustering
{
    ...
    public partial interface INodeMappingService
    {
        ...
        /// </returns>
        Task<IQueryable<TEntity>> ApplyNodeMapping<TEntity>(IQueryable<TEntity> query, int nodeId) where TEntity : DataEntity, ISupportNodeMapping;
        ...
        /// </returns>
        Task<IList<NodeMapping>> GetNodeMappingsAsync<TEntity>(TEntity entity) where TEntity : DataEntity, ISupportNodeMapping;
        ...
        /// <returns>A task that represents the asynchronous operation</returns>
        Task InsertNodeMappingAsync<TEntity>(TEntity entity, int nodeId) where TEntity : DataEntity, ISupportNodeMapping;
        ...
        /// </returns>
        Task<int[]> GetNodesIdsWithAccessAsync<TEntity>(TEntity entity) where TEntity : DataEntity, ISupportNodeMapping;
        ...
        /// </returns>
        int[] GetNodesIdsWithAccess<TEntity>(TEntity entity) where TEntity : DataEntity, ISupportNodeMapping;
        ...
        /// </returns>
        Task<bool> AuthorizeAsync<TEntity>(TEntity entity) where TEntity : DataEntity, ISupportNodeMapping;
        ...
        /// The task result contains the rue - authorized; otherwise, false
        /// </returns>
        Task<bool> AuthorizeAsync<TEntity>(TEntity entity, int nodeId) where TEntity : DataEntity, ISupportNodeMapping;
        ...
        /// </returns>
        bool Authorize<TEntity>(TEntity entity, int nodeId) where TEntity : DataEntity, ISupportNodeMapping;
    }
}