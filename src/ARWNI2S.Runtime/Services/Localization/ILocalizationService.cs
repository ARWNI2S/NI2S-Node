...
namespace ARWNI2S.Services.Localization
{
    ...
    public partial interface ILocalizationService
    {
        ...
        ///// <summary>
        ///// Get localized property of gameplay setting
        ///// </summary>
        ///// <typeparam name="TSettings">Settings type</typeparam>
        ///// <param name="settings">Settings</param>
        ///// <param name="keySelector">Key selector</param>
        ///// <param name="languageId">GameLanguage identifier</param>
        ///// <param name="returnDefaultValue">A value indicating whether to return default value (if localized is not found)</param>
        ///// <param name="ensureTwoPublishedLanguages">A value indicating whether to ensure that we have at least two published languages; otherwise, load only default value</param>
        ///// <returns>
        ///// A task that represents the asynchronous operation
        ///// The task result contains the localized property
        ///// </returns>
        //Task<string> GetLocalizedGameSettingAsync<TSettings>(TSettings settings, Expression<Func<TSettings, string>> keySelector,
        //    int languageId, bool returnDefaultValue = true, bool ensureTwoPublishedLanguages = true)
        //    where TSettings : IGameplaySettings, new();

        ///// <summary>
        ///// Save localized property of gameplay setting
        ///// </summary>
        ///// <typeparam name="TSettings">Settings type</typeparam>
        ///// <param name="settings">Settings</param>
        ///// <param name="keySelector">Key selector</param>
        ...
        ///// The task result contains the localized property
        ///// </returns>
        //Task SaveLocalizedGameSettingAsync<TSettings>(TSettings settings, Expression<Func<TSettings, string>> keySelector,
        //    int languageId, string value) where TSettings : IGameplaySettings, new();
