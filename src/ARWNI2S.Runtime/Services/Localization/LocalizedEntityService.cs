...
namespace ARWNI2S.Services.Localization
{
    ...
    public partial class LocalizedEntityService : ILocalizedEntityService
    {
        ...
        {
            var key = _staticCacheManager.PrepareKeyForDefaultCache(LocalizationServicesDefaults.LocalizedPropertiesCacheKey,
        ...
        {
            var key = _staticCacheManager.PrepareKeyForDefaultCache(LocalizationServicesDefaults.LocalizedPropertyCacheKey
            ...
            return await _staticCacheManager.GetAsync(key, async () =>
            {
                if (_localizationSettings.LoadAllLocalizedPropertiesOnStartup)
                {
                    var lookupKey = _staticCacheManager.PrepareKeyForDefaultCache(
                        LocalizationServicesDefaults.LocalizedPropertyLookupCacheKey,
                        languageId);
