...
namespace ARWNI2S.Services.Scheduling
{
    /// <summary>
    /// Represents background cluster task manager
    /// </summary>
    public partial class ClusterJobScheduler : IClusterTaskScheduler
    {
        #region Fields
        ...
        public ClusterJobScheduler(NI2SSettings ni2sSettings,
        ...
        protected partial class ClusterTaskThread : IDisposable
        {
            ...
            private async Task RunAsync()
            {
                ...
                catch (Exception ex)
                {
                    ...
                    // Resolve
                    var logger = NI2SEngineContext.Current.Resolve<ILogService>(scope);
                    var localizationService = NI2SEngineContext.Current.Resolve<ILocalizationService>(scope);
                    var nodeContext = NI2SEngineContext.Current.Resolve<IClusterContext>(scope);
