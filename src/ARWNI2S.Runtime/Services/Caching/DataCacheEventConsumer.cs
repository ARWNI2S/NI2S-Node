...
using ARWNI2S.Data.EventSourcing;
using ARWNI2S.Engine;
using ARWNI2S.EventSourcing;

namespace ARWNI2S.Services.Caching
{
    /// <summary>
    /// Represents the base entity cache event consumer
    /// </summary>
    /// <typeparam name="TEntity">Entity type</typeparam>
    public abstract partial class DataCacheEventConsumer<TEntity> :
        ...
        where TEntity : DataEntity
    {
        ...
        protected DataCacheEventConsumer()
        {
            _staticCacheManager = NI2SEngineContext.Current.Resolve<IStaticCacheManager>();
        }
        ...
        /// <returns>A task that represents the asynchronous operation</returns>
        public virtual async Task HandleEventAsync(DataEntityCreated<TEntity> eventMessage)
        {
        ...
        /// <param name="eventMessage">Event message</param>
        /// <returns>A task that represents the asynchronous operation</returns>
        public virtual async Task HandleEventAsync(DataEntityUpdated<TEntity> eventMessage)
        {
        ...
        /// <param name="eventMessage">Event message</param>
        /// <returns>A task that represents the asynchronous operation</returns>
        public virtual async Task HandleEventAsync(DataEntityDeleted<TEntity> eventMessage)
        {
