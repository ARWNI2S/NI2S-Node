...
{
    public sealed class NI2SNodeHostBuilder : IHostApplicationBuilder
    {
        private readonly HostApplicationBuilder _hostApplicationBuilder;
        private readonly ServiceDescriptor _genericNodeHostServiceDescriptor;

        private NI2SNodeHost _builtEngine;
        ...
        /// <summary>
        /// Provides information about the hosting environment a node is running.
        /// </summary>
        ...
        /// <summary>
        /// An <see cref="INodeHostBuilder"/> for configuring host specific properties, but not building.
        /// To build after configuration, call <see cref="Build"/>.
        /// </summary>
        public ConfigureNodeHostBuilder NodeHost { get; private set; }

        internal NI2SNodeHostBuilder(NI2SNodeOptions options, Action<IHostBuilder> configureDefaults = null)
        {
            ...
            {
                Configuration.AddInMemoryCollection([new KeyValuePair<string, string>(NI2SNodeDefaults.NodeRootKey, options.NodeRootPath)]);
            }
        ...
        {
            ((IHostApplicationBuilder)_hostApplicationBuilder).ConfigureContainer(factory, configure);
        }

        /// <summary>
        /// Builds the <see cref="NI2SNodeHost"/>.
        /// </summary>
        /// <returns>A configured <see cref="NI2SNodeHost"/>.</returns>
        public NI2SNodeHost Build()
        {
            ...
            _builtEngine = new NI2SNodeHost(_hostApplicationBuilder.Build());
            return _builtEngine;
        }
