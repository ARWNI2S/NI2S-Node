        ...
        protected partial class TaskThread : IDisposable
        {
            ...
            protected virtual async Task RunAsync()
            {
                ...
                catch (Exception /*ex*/)
                {
                    ...
                    // Resolve
                    var logger = NI2SContext.Current.Resolve<ILogger>(scope);
                    //var localizationService = NI2SContext.Current.Resolve<ILocalizationService>(scope);
                    //var storeContext = NI2SContext.Current.Resolve<IStoreContext>(scope);
