...
using ARWNI2S.Engine.Data.Configuration;
...
namespace ARWNI2S.Engine.Data
{
    ...
    public partial class DataSettingsManager
    {
        ...
        /// <returns>Data settings</returns>
        public static DataConfig LoadSettings(INiisFileProvider fileProvider = null, bool reload = false)
        {
            if (!reload && Singleton<DataConfig>.Instance is not null)
                return Singleton<DataConfig>.Instance;

            //backward compatibility
            fileProvider ??= NI2SFileProvider.Default;
        ...
        /// <param name="fileProvider">File provider</param>
        public static void SaveSettings(DataConfig dataSettings, INiisFileProvider fileProvider)
        {
            NI2SSettingsHelper.SaveNodeSettings([dataSettings], fileProvider);
