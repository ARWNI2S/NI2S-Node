...
namespace ARWNI2S.Data.Mapping
{
    ...
    /// </summary>
    public static class DataMappingSchema
    {
        #region Fields

        private static ConcurrentDictionary<Type, DataEntityDescriptor> EntityDescriptors { get; } = new();
        ...
        public static DataEntityDescriptor GetEntityDescriptor(Type entityType)
        {
            ...
            return EntityDescriptors.GetOrAdd(entityType, t =>
            {
                ...
                return new DataEntityDescriptor
                {
                    EntityName = tableName,
                    SchemaName = builder.Expression.SchemaName,
                    Fields = builder.Expression.Columns.Select(column => new DataEntityFieldDescriptor
                    {
                        Name = column.Name,
