...
{
    public partial class MySqlServerDataProvider : BaseDataProvider, INiisDataProvider
    {
        #region Fields
        ...
        public virtual async Task<int?> GetTableIdentAsync<TEntity>() where TEntity : DataEntity
        {
            ...
            var tableName = DataMappingSchema.GetEntityDescriptor(typeof(TEntity)).EntityName;
