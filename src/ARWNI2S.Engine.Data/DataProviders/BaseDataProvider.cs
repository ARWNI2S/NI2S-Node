...
namespace ARWNI2S.Data.DataProviders
{
    public abstract partial class BaseDataProvider
    {
        ...
        protected virtual DataConnection CreateDataConnection(IDataProvider dataProvider)
        {
            ...
            var dataConnection = new DataConnection(dataProvider, CreateDbConnection(), DataMappingSchema.GetMappingSchema(ConfigurationName))
            {
        ...
        {
            var migrationManager = NI2SEngineContext.Current.Resolve<IMigrationManager>();
        ...
        public virtual IQueryable<TEntity> GetTable<TEntity>() where TEntity : DataEntity
        {
            var options = new DataOptions()
                ...
                .UseMappingSchema(DataMappingSchema.GetMappingSchema(ConfigurationName));
