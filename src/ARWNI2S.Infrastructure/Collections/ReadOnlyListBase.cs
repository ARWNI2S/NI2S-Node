...
namespace ARWNI2S.Collections
{
    ...
    [Serializable]
    internal abstract class ReadOnlyListBase<T> : ReadOnlyCollectionBase<T>, IList<T>, IList
    {
        /// <summary>
        ...
        {
            throw new NotSupportedException(string.Format(LocalizedStrings.Collections_CannotModifyCollection, CollectionUtils.SimpleClassName(GetType())));
        }
        ...
        /// <exception cref="InvalidOperationException">Indexer must be overrided.</exception>
        public virtual T this[int index]
        {
            get
            {
                throw new InvalidOperationException(LocalizedStrings.Collections_MustOverrideIndexerGet);
            }
        ...
        {
            return CollectionAlgorithms.FindFirstWhere(this, predicate);
        }
        ...
        {
            return CollectionAlgorithms.TryFindFirstWhere(this, predicate, out foundItem);
        }
        ...
        {
            return CollectionAlgorithms.FindLastWhere(this, predicate);
        }
        ...
        {
            return CollectionAlgorithms.TryFindLastWhere(this, predicate, out foundItem);
        }
        ...
        {
            return CollectionAlgorithms.FindFirstIndexWhere(this, predicate);
        }
        ...
        {
            int foundIndex = CollectionAlgorithms.FindFirstIndexWhere(Range(index, Count - index), predicate);
            if (foundIndex < 0)
                return -1;
            else
        ...
        {
            int foundIndex = CollectionAlgorithms.FindFirstIndexWhere(Range(index, count), predicate);
            if (foundIndex < 0)
                return -1;
            else
                return foundIndex + index;
        ...
        {
            return CollectionAlgorithms.FindLastIndexWhere(this, predicate);
        }
        ...
        {
            return CollectionAlgorithms.FindLastIndexWhere(Range(0, index + 1), predicate);
        }
        ...
        {
            int foundIndex = CollectionAlgorithms.FindLastIndexWhere(Range(index - count + 1, count), predicate);
        ...
        {
            return CollectionAlgorithms.FirstIndexOf(this, item, EqualityComparer<T>.Default);
        }
        ...
        {
            int foundIndex = CollectionAlgorithms.FirstIndexOf(Range(index, Count - index), item, EqualityComparer<T>.Default);
        ...
        {
            int foundIndex = CollectionAlgorithms.FirstIndexOf(Range(index, count), item, EqualityComparer<T>.Default);
        ...
        {
            return CollectionAlgorithms.LastIndexOf(this, item, EqualityComparer<T>.Default);
        }
        ...
        {
            int foundIndex = CollectionAlgorithms.LastIndexOf(Range(0, index + 1), item, EqualityComparer<T>.Default);
        ...
        {
            int foundIndex = CollectionAlgorithms.LastIndexOf(Range(index - count + 1, count), item, EqualityComparer<T>.Default);
        ...
        {
            return CollectionAlgorithms.Range(this, start, count);
        }
        ...
        [SuppressMessage("Microsoft.Design", "CA1033:InterfaceMethodsShouldBeCallableByChildTypes", Justification = "Custom collection base class")]
