...
namespace ARWNI2S.Collections
{
                                                                                                  ...
                                                                                                  IDictionary<TKey, TValue>, IDictionary
    {
        ...
        public virtual TValue this[TKey key]
        {
            ...
            set
            {
                throw new NotImplementedException(LocalizedStrings.Collections_MustOverrideIndexerSet);
            }
        }
        ...
        /// <summary>
        /// Checks that the given parameter is of the expected generic type. Throw an ArgumentException
        /// if it isn't.
        /// </summary>
        ...
        private static void CheckGenericType<ExpectedType>(string name, object value)
        {
            if (!(value is ExpectedType))
                throw new ArgumentException(string.Format(LocalizedStrings.Collections_WrongType, value, typeof(ExpectedType)), name);
        }
        ...
        new public string DebuggerDisplayString()
        {
        ...
        private sealed class KeysCollection : ReadOnlyCollectionBase<TKey>
        {
            ...
            {
                foreach (KeyValuePair<TKey, TValue> pair in _myDictionary)
        ...
        private class DictionaryEnumeratorWrapper : IDictionaryEnumerator
        {
            ...
            public void Reset()
            {
                throw new NotSupportedException(LocalizedStrings.Collections_ResetNotSupported);
            }
