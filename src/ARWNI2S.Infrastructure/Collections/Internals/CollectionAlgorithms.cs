...
namespace ARWNI2S.Collections.Internals
{
    /// <summary>
    ...
    /// </summary>
    internal static class CollectionAlgorithms
    {
        ...
        private class ListRange<T> : ListBase<T>, ICollection<T>
        {
            ...
            public override bool Remove(T item)
            {
                if (_wrappedList.IsReadOnly)
                    throw new NotSupportedException(string.Format(LocalizedStrings.Collections_CannotModifyCollection, "Range"));
                else
        ...
        private class ArrayRange<T> : ListBase<T>
        {
            ...
            public override void Clear()
            {
                ...
                FillRange(_wrappedArray, _wrappedArray.Length - _count, _count, default);
                _count = 0;
            }
        ...
        private class ReadOnlyCollection<T> : ICollection<T>
        {
            ...
            {
                throw new NotSupportedException(string.Format(LocalizedStrings.Collections_CannotModifyCollection, "read-only collection"));
            }
        ...
        private class ReadOnlyList<T> : IList<T>
        {
            ...
            private static void MethodModifiesCollection()
            {
                throw new NotSupportedException(string.Format(LocalizedStrings.Collections_CannotModifyCollection, "read-only list"));
            }
        ...
        private class ReadOnlyDictionary<TKey, TValue> : IDictionary<TKey, TValue>
        {
            ...
            private static void MethodModifiesCollection()
            {
                throw new NotSupportedException(string.Format(LocalizedStrings.Collections_CannotModifyCollection, "read-only dictionary"));
            }
        ...
        private class TypedCollection<T> : ICollection<T>
        {
            ...
            private static void MethodModifiesCollection()
            {
                throw new NotSupportedException(string.Format(LocalizedStrings.Collections_CannotModifyCollection, "strongly-typed Collection"));
            }
        ...
        private class UntypedList<T> : IList
        {
            ...
            private static T ConvertToItemType(string name, object value)
            {
                ...
                {
                    throw new ArgumentException(string.Format(LocalizedStrings.Collections_WrongType, value, typeof(T)), name);
                }
            }
        ...
        public static IEnumerable<T> SetUnion<T>(IEnumerable<T> collection1, IEnumerable<T> collection2, IEqualityComparer<T> equalityComparer)
        {
            ...
            {
                bag2.UnionWith(bag1);
                return CollectionUtils.CreateEnumerableWrapper(bag2);
            }
        }
        ...
        private static Randomizer GetRandomGenerator()
        {
            ...
            {
                myRandomGenerator = Randomizer.CreateRandomizer();
            }
        ...
        public static IEnumerable<T[]> GeneratePermutations<T>(IEnumerable<T> collection)
        {
            ...
            int[] entity = new int[array.Length - 1];
            ...
            for (; ; )
            {
                if (entity[i] < i + 1)
                {
                    ...
                    {
                        temp = array[i + 1];
                        array[i + 1] = array[entity[i] - 1];
                        array[entity[i] - 1] = temp;
                    }

                    temp = array[i + 1];
                    array[i + 1] = array[entity[i]];
                    array[entity[i]] = temp;
        ...
        {
            return GenerateSortedPermutations(collection, Compare.ComparerFromComparison(comparison));
        }
        ...
        {
            return Maximum(collection, Compare.ComparerFromComparison(comparison));
        }
        ...
        {
            return Minimum(collection, Compare.ComparerFromComparison(comparison));
        }
        ...
        {
            return IndexOfMaximum(list, Compare.ComparerFromComparison(comparison));
        }
        ...
        {
            return IndexOfMinimum(list, Compare.ComparerFromComparison(comparison));
        }
        ...
        {
            return Sort(collection, Compare.ComparerFromComparison(comparison));
        }
        ...
        {
            SortInPlace(list, Compare.ComparerFromComparison(comparison));
        }
        ...
        {
            return StableSort(collection, Compare.ComparerFromComparison(comparison));
        }
        ...
        {
            StableSortInPlace(list, Compare.ComparerFromComparison(comparison));
        }
        ...
        {
            return BinarySearch(list, item, Compare.ComparerFromComparison(comparison), out index);
        }
        ...
        {
            return MergeSorted(Compare.ComparerFromComparison(comparison), collections);
        }
        ...
        {
            return LexicographicalCompare(sequence1, sequence2, Compare.ComparerFromComparison(comparison));
        }
        ...
        {
            readonly IComparer<T> _itemComparer;
        ...
        private class CollectionEqualityComparer<T> : IEqualityComparer<IEnumerable<T>>
        {
            ...
            public int GetHashCode(IEnumerable<T> obj)
            {
                ...
                foreach (T t in obj)
                {
                    int itemHash = CollectionUtils.GetHashCode(t, _equalityComparer);
                    hash += itemHash;
                    hash = hash << 9 | hash >> 23;
                }
