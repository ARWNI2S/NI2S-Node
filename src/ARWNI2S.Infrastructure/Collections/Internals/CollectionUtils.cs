...
{
    /// <summary>
    /// A holder class for various public utility functions that need to be shared.
    /// </summary>
    internal static class CollectionUtils
    {
        ...
        /// <summary>
        /// Wrap an enumerable so that nodeClients can't get to the underlying 
        /// implementation via a down-cast.
        /// </summary>
        [Serializable]
        class WrapEnumerable<T> : IEnumerable<T>
        {
            IEnumerable<T> _wrapped;
