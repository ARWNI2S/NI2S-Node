...
namespace ARWNI2S.Collections.Generic
{
    ...
    public class Deque<T> : ListBase<T>, ICloneable
    {
        ...
        /// items that this Deque can hold without expanding its public buffer. Since
...
//#if DEBUG
//        /// <summary>
//        /// Print out the public state of the Deque for debugging.
//        /// </summary>
//        public void Print()
//        {
//            ConsoleText.WriteLine("length={0}  start={1}  end={2}", buffer.Length, start, end);
...
//                else
//                    Console.Write("      ");
//                ConsoleText.WriteLine("{0,4} {1}", i, buffer[i]);
//            }
//            Console.ReadKey();
//        }
//#endif // DEBUG
