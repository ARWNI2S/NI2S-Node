...
using ARWNI2S.Infrastructure.Telemetry.Consumers;
...
namespace ARWNI2S.Infrastructure.Logging
{
    ...
    public class TraceLogger : Logger
    {
        ...
        public static string LoggerDirectory = Utils.MapPath("~/Log");

        /// <summary>
        /// Trave Levels table
        /// </summary>
        public static string[] TraceLevelTable = { "OFF       ", "ERROR     ", "WARNING   ", "INFO      ", "VERBOSE   ", "VERBOSE-2 ", "VERBOSE-3 " };
...
//#endif
        ...
        /// </summary>
        public override LogLevel TraceLevel
        {
            get
            {
        ...
        {
            if (config == null) throw new ArgumentNullException("config", LocalizedStrings.TraceLogger_Initialize_ArgumentNullException);
        ...
        {
            Log(logCode, LogLevel.Warning, message, new object[] { }, exception);
        }
        /// <summary>
        ...
        {
            Log(logCode, LogLevel.Error, message, new object[] { }, exception);
        }
        ...
        {
            Log((int)errorCode, LogLevel.Warning, message, new object[] { }, exception);
        }
        public void Error(TraceCode errorCode, string message, Exception exception = null)
        {
            Log((int)errorCode, LogLevel.Error, message, new object[] { }, exception);
        }
