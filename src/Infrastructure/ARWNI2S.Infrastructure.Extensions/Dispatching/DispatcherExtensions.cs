using ARWNI2S.Infrastructure.Dispatching;

namespace ARWNI2S.Infrastructure.Extensions.Dispatching
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Schedules the provided callback on the simulation thread from a worker thread, and returns the results asynchronously.
        /// </summary>
        ...
        /// <summary>
        /// Schedules the provided action on the simulation thread from a worker thread.
        /// </summary>
        /// <param name="dispatcher">The <see cref="IDispatcher"/> instance this method is called on.</param>
        ...
        /// <summary>
        /// Schedules the provided function on the simulation thread from a worker thread.
        /// </summary>
        /// <typeparam name="T">The type returned from this method.</typeparam>
        /// <param name="dispatcher">The <see cref="IDispatcher"/> instance this method is called on.</param>
