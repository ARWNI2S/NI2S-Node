...
namespace ARWNI2S.Infrastructure.Collections.Sorted
{
    ...
    public class OrderedMultiDictionary<TKey, TValue> : MultiDictionaryBase<TKey, TValue>, ICloneable
    {
        ...
        private RedBlackTree<KeyValuePair<TKey, TValue>>.RangeTester KeyRange(TKey key)
        {
            ...
            {
                return _keyComparer.Compare(pair.Key, key);
            };
        }
        ...
        public OrderedMultiDictionary(bool allowDuplicateValues)
            : this(allowDuplicateValues, Compare.DefaultComparer<TKey>(), Compare.DefaultComparer<TValue>())
        {
        }
        ...
        public OrderedMultiDictionary(bool allowDuplicateValues, Comparison<TKey> keyComparison)
            : this(allowDuplicateValues, Compare.ComparerFromComparison(keyComparison), Compare.DefaultComparer<TValue>())
        {
        }
        ...
        public OrderedMultiDictionary(bool allowDuplicateValues, Comparison<TKey> keyComparison, Comparison<TValue> valueComparison)
            : this(allowDuplicateValues, Compare.ComparerFromComparison(keyComparison), Compare.ComparerFromComparison(valueComparison))
        {
        }
        ...
        public OrderedMultiDictionary(bool allowDuplicateValues, IComparer<TKey> keyComparer)
            : this(allowDuplicateValues, keyComparer, Compare.DefaultComparer<TValue>())
        {
        }
        ...
        public OrderedMultiDictionary(bool allowDuplicateValues, IComparer<TKey> keyComparer, IComparer<TValue> valueComparer)
        {
            ...
            _comparer = Compare.ComparerPairFromKeyValueComparers(keyComparer, valueComparer);
        ...
        public sealed override void Add(TKey key, TValue value)
        {
            ...
            _tree.Insert(pair, _allowDuplicateValues ? DuplicatePolicy.InsertLast : DuplicatePolicy.ReplaceLast, out KeyValuePair<TKey, TValue> dummy);
        }
        ...
        {
            bool found = _tree.Delete(NewPair(key, value), false, out KeyValuePair<TKey, TValue> dummy);
        ...
        {
            return _tree.Find(NewPair(key, value), true, false, out KeyValuePair<TKey, TValue> dummy);
        }
        ...
        {
            return _tree.FirstItemInRange(KeyRange(key), out KeyValuePair<TKey, TValue> dummy) >= 0;
        }
        ...
        private IEnumerator<TKey> EnumerateKeys(RedBlackTree<KeyValuePair<TKey, TValue>>.RangeTester rangeTester, bool reversed)
        {
            ...
            if (reversed)
                pairs = _tree.EnumerateRangeReversed(rangeTester);
            else
                pairs = _tree.EnumerateRange(rangeTester);
        ...
        {
            foreach (KeyValuePair<TKey, TValue> pair in _tree.EnumerateRange(KeyRange(key)))
        ...
        {
            OrderedMultiDictionary<TKey, TValue> newDict = new OrderedMultiDictionary<TKey, TValue>(_allowDuplicateValues, _keyCount, _keyComparer, _valueComparer, _comparer, _tree.Clone());
            return newDict;
        }
        ...
        {
            throw new InvalidOperationException(string.Format(LocalizedStrings.Collections_TypeNotCloneable, t.FullName));
        }
        ...
        public OrderedMultiDictionary<TKey, TValue> CloneContents()
        {
            ...
            OrderedMultiDictionary<TKey, TValue> newDict = new OrderedMultiDictionary<TKey, TValue>(_allowDuplicateValues, _keyComparer, _valueComparer);
        ...
        private sealed class KeyValuePairsCollection : ReadOnlyCollectionBase<KeyValuePair<TKey, TValue>>
        {
            ...
            {
                return _myDictionary._tree.Find(pair, true, false, out KeyValuePair<TKey, TValue> dummy);
            }
        }
        ...
        ///</remarks>
        [Serializable]
        internal class View : MultiDictionaryBase<TKey, TValue>
        {
            private readonly OrderedMultiDictionary<TKey, TValue> _myDictionary;
            ...
            public View(OrderedMultiDictionary<TKey, TValue> myDictionary, RedBlackTree<KeyValuePair<TKey, TValue>>.RangeTester rangeTester, bool entireTree, bool reversed)
            {
                _myDictionary = myDictionary;
            ...
            public sealed override int Count
            {
                get
                {
                    ...
                    else
                    {
                        ...
                        using (IEnumerator<TKey> enumKeys = _myDictionary.EnumerateKeys(_rangeTester, _reversed))
                        {
