...
namespace ARWNI2S.Engine.Infrastructure
{
    ...
    public partial class CommonHelper
    {
        ...
        public static void SetProperty(object instance, string propertyName, object value)
        {
            ...
            var pi = instanceType.GetProperty(propertyName) ?? throw new NI2SException($"No property '{propertyName}' found on the instance of type '{instanceType}'.");
            if (!pi.CanWrite)
                throw new NI2SException($"The property '{propertyName}' on the instance of type '{instanceType}' does not have a setter.");
