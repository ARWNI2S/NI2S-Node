...
namespace ARWNI2S.Infrastructure
{
    ...
    /// </summary>
    public partial class NiisFileProvider : PhysicalFileProvider, INiisFileProvider
    {
        /// <summary>
        /// Initializes a new instance of a NiisFileProvider
        /// </summary>
        /// <param name="hostEnvironment">Hosting environment</param>
        public NiisFileProvider(IHostEnvironment hostEnvironment)
        ...
        {
            RootPath = File.Exists(hostEnvironment.ContentRootPath)
                ? Path.GetDirectoryName(hostEnvironment.ContentRootPath)
                : hostEnvironment.ContentRootPath;
        }

        protected NiisFileProvider(string root)
            : base(root) { }
    ...
    //    public NiisFileProvider(IWebHostEnvironment webHostEnvironment)
