...
namespace ARWNI2S.Engine.Installation
{
    ...
    public partial class InstallationService : IInstallationService
    {
        ...
        //	//default node 
        //	var defaultNode = await _nodeRepository.Table.FirstOrDefaultAsync() ?? throw new NI2SException("No default node could be loaded");
        ...
        //		?? userService.GetUserByEmailAsync(adminUserEmail) ?? throw new NI2SException($"Not found: {adminUserEmail}");
