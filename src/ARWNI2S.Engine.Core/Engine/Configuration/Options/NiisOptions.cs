namespace ARWNI2S.Engine.Configuration.Options
{
    ...
    ///// <summary>
    ///// Provides programmatic configuration for the NI2S framework.
    ///// </summary>
    //public class NiisOptions : IEnumerable<ICompatibilitySwitch>
    //{
    ...
    //    /// logic should be used. Endpoint routing is used to match HTTP requests to NI2S actions, and to generate
    ...
    //    /// <remarks>
    //    /// <para>
    //    /// This option controls whether NI2S model binding and validation treats nullable and non-nullable
    //    /// reference types differently.
    //    /// </para>
    //    /// <para>
    //    /// By default, NI2S will treat a non-nullable reference type parameters and properties as-if
    //    /// <c>[Required]</c> has been applied, resulting in validation errors when no value was bound.
    //    /// </para>
    //    /// <para>
    //    /// NI2S does not support non-nullable reference type annotations on type arguments and type parameter
    ...
    //    /// <summary>
    //    /// Gets or sets the flag that determines if NI2S should use action invoker extensibility. This will allow
    ...
    //    /// <summary>
    //    /// Gets or sets a value that determines if NI2S will remove the suffix "Async" applied to
    //    /// controller action names.
    //    /// <para>
    //    /// <see cref="ControllerActionDescriptor.ActionName"/> is used to construct the route to the action as
    //    /// well as in view lookup. When <see langword="true"/>, NI2S will trim the suffix "Async" applied
