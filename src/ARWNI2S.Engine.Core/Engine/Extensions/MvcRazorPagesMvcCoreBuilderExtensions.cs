...
{
    /// <summary>
    /// Static class that adds razor page functionality to <see cref="INiisCoreBuilder"/>.
    /// </summary>
    public static class NiisRazorPagesNiisCoreBuilderExtensions
    {
        /// <summary>
        ...
        public static INiisCoreBuilder AddRazorPages(this INiisCoreBuilder builder)
        {
        ...
        /// <returns>The <see cref="INiisCoreBuilder"/>.</returns>
        public static INiisCoreBuilder AddRazorPages(
        ...
        /// <returns></returns>
        public static INiisCoreBuilder WithRazorPagesRoot(this INiisCoreBuilder builder, string rootDirectory)
        {
            ArgumentNullException.ThrowIfNull(builder);
