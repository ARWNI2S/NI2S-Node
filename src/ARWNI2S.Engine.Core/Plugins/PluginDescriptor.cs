...
namespace ARWNI2S.Plugins
{
    ...
    public partial class PluginDescriptor : PluginDescriptorBaseInfo, IDescriptor, IComparable<PluginDescriptor>
    {
        ...
        public virtual TPlugin Instance<TPlugin>() where TPlugin : class, IPlugin
        {
            ...
            var instance = NI2SEngineContext.Current.ResolveUnregistered(PluginType);
        ...
        public virtual void Save()
        {
            ...
            if (OriginalAssemblyFile == null)
                throw new NiisException($"Cannot load original assembly path for {SystemName} plugin.");
            ...
            if (!fileProvider.FileExists(filePath))
                throw new NiisException($"Description file for {SystemName} plugin does not exist. {filePath}");
