...
namespace ARWNI2S.Caching
{
    ...
    public abstract class DistributedCacheManager : CacheKeyService, IStaticCacheManager
    {
        ...
        protected DistributedCacheManager(NI2SSettings niisSettings,
        ...
        /// <summary>Performs engine-defined tasks associated with freeing, releasing, or resetting unmanaged resources.</summary>
        public void Dispose()
        {
