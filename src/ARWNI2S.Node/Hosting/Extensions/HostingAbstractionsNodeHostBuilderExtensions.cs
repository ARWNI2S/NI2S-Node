...
namespace ARWNI2S.Node.Hosting.Extensions
{
    ...
    public static class HostingAbstractionsNodeHostBuilderExtensions
    {
        ...
        /// <returns>The <see cref="INodeHostBuilder"/>.</returns>
        public static INodeHostBuilder UseServer(this INodeHostBuilder hostBuilder, IServer server)
        {
        ...
        /// <returns>The <see cref="INodeHostBuilder"/>.</returns>
        public static INodeHostBuilder UseNodeRoot(this INodeHostBuilder hostBuilder, string webRoot)
        {
        ...
        /// <returns>The <see cref="INodeHostBuilder"/>.</returns>
        public static INodeHostBuilder UseUrls(this INodeHostBuilder hostBuilder, [StringSyntax(StringSyntaxAttribute.Uri)] params string[] urls)
        {
        ...
        /// <param name="urls">The urls the hosted application will listen on.</param>
        /// <returns>The <see cref="INodeHostBuilder"/>.</returns>
        public static INodeHost Start(this INodeHostBuilder hostBuilder, [StringSyntax(StringSyntaxAttribute.Uri)] params string[] urls)
        {
