...
using ARWNI2S.Reflection.Extensions;
...
{
    internal sealed class GenericNodeHostBuilder : NodeHostBuilderBase, ISupportsNodeStartup
    {
            ...
            : base(builder, options)
        {
            ...
            _builder.ConfigureServices((context, services) =>
            {
                ...
                // Add the IHostingEnvironment and IEngineLifetime from Microsoft.AspNetCore.Hosting
...
#pragma warning disable CS0618 // Type or member is obsolete
                ...
                services.AddSingleton<IEngineLifetime, GenericNodeHostEngineLifetime>();
#pragma warning restore CS0618 // Type or member is obsolete

                services.Configure<GenericNodeHostServiceOptions>(options =>
                {
                    // Set the options
                    options.NodeHostOptions = webHostOptions;
                ...
                services.TryAddSingleton<INiisContextFactory, DefaultNiisContextFactory>();
                ...
                {
                    ScanAssemblyAndRegisterStartup(context, services, nodehostContext, webHostOptions);
                }
            });
        }
        ...
        private void ScanAssemblyAndRegisterStartup(HostBuilderContext context, IServiceCollection services, NodeHostBuilderContext nodehostContext, NodeHostOptions webHostOptions)
        {
            try
            {
                var startupType = StartupLoader.FindStartupType(webHostOptions.StartupAssembly!, nodehostContext.HostingEnvironment.EnvironmentName);
        ...
        public INodeHostBuilder Configure(Action<IEngineBuilder> configure)
        {
            ...
            _builder.ConfigureServices((context, services) =>
            {
                if (ReferenceEquals(_startupObject, configure))
                {
                    services.Configure<GenericNodeHostServiceOptions>(options =>
                    {
                        options.ConfigureEngine = configure;
                    });
                }
            });
...
#pragma warning disable CS0618 // Type or member is obsolete
                if (serviceType == typeof(Microsoft.Extensions.Hosting.IHostingEnvironment)
                    || serviceType == typeof(Hosting.IHostingEnvironment)
#pragma warning restore CS0618 // Type or member is obsolete
