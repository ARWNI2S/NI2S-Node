...
namespace ARWNI2S.Node.Hosting.Generic
{
    public static class GenericHostBuilderExtensions
    {
        ...
        ///     <item><description>configure <see cref="IHostEnvironment.ContentRootFileProvider"/> to include local assets from projects referenced by the entry assembly during development</description></item>
