...
namespace ARWNI2S.ApplicationParts
{
    ...
    /// <para>
    /// By default, Niis registers each application assembly that it discovers as an <see cref="AssemblyPart"/>.
    ...
    public abstract class ApplicationPartFactory
    {
        ...
        public static ApplicationPartFactory GetApplicationPartFactory(Assembly assembly)
        {
            ...
            {
                throw new InvalidOperationException(string.Format(ErrorStrings.FormatApplicationPartFactory_InvalidFactoryType,
                    type,
