...
{
    /// <summary>
    /// Represents a collection of node modules.
    /// </summary>
    public interface IModuleCollection : IEnumerable<KeyValuePair<Type, IModuleInfo>>
    {
        /// <summary>
        ...
        IModuleInfo this[Type key] { get; set; }
        ...
        /// <returns>The requested module, or null if it is not present.</returns>
        TModule Get<TModule>() where TModule : IModuleInfo;
        ...
        void Set<TModule>(TModule instance) where TModule : IModuleInfo;
    }
}