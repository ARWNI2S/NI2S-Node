...
namespace ARWNI2S.Framework.Configuration
{
    ...
    public partial interface ISettingService
    {
        ...
        /// </returns>
        Task<ISetting> GetSettingByIdAsync(int settingId);
        ...
        Task DeleteSettingAsync(ISetting setting);
        ...
        /// <returns>A task that represents the asynchronous operation</returns>
        Task DeleteSettingsAsync(IList<ISetting> settings);
        ...
        /// The task result contains the setting
        /// </returns>
        Task<ISetting> GetSettingAsync(string key, int nodeId = 0, bool loadSharedValueIfNotFound = false);
        ...
        /// The setting
        /// </returns>
        ISetting GetSetting(string key, int nodeId = 0, bool loadSharedValueIfNotFound = false);
        ...
        /// </returns>
        Task<IList<ISetting>> GetAllSettingsAsync();
        ...
        /// <param name="clearCache">A value indicating whether to clear cache after setting update</param>
        /// <returns>A task that represents the asynchronous operation</returns>
        Task InsertSettingAsync(ISetting setting, bool clearCache = true);
        ...
        /// <param name="setting">Setting</param>
        /// <param name="clearCache">A value indicating whether to clear cache after setting update</param>
        void InsertSetting(ISetting setting, bool clearCache = true);
        ...
        /// <param name="clearCache">A value indicating whether to clear cache after setting update</param>
        /// <returns>A task that represents the asynchronous operation</returns>
        Task UpdateSettingAsync(ISetting setting, bool clearCache = true);
        ...
        /// <param name="setting">Setting</param>
        /// <param name="clearCache">A value indicating whether to clear cache after setting update</param>
        void UpdateSetting(ISetting setting, bool clearCache = true);
