...
namespace ARWNI2S.Hosting.Builder
{
    internal abstract class NodeHostBuilderBase : INiisHostBuilder//TODO:, ISupportsUseDefaultServiceProvider remove or add?
    {
        ...
        protected NI2SHostBuilderContext GetNI2SHostBuilderContext(HostBuilderContext context)
        {
            ...
            {
                // Use _config as a fallback for NI2SHostOptions in case the chained source was removed from the hosting IConfigurationBuilder.
                var options = new NI2SHostOptions(context.Configuration, fallbackConfiguration: _config, environment: context.HostingEnvironment);
                ...
                context.Properties[typeof(NI2SHostOptions)] = options;
