...
namespace ARWNI2S.Hosting.Internals
{
    ...
    /// </summary>
    internal static class NI2SCoreExtensions
    {
        #region Fields
        ...
        /// <returns>Assembly</returns>
        private static Assembly PerformFileDeploy(this IApplicationPartManager applicationPartManager,
            string assemblyFile, PluginConfig pluginConfig, INiisFileProvider fileProvider)
        {
            ...
            var assembly =
                AddApplicationParts(applicationPartManager as ApplicationPartManager, assemblyFile, pluginConfig.UseUnsafeLoadAssembly);
        ...
        /// <param name="applicationPartManager">Engine part manager</param>
        /// <param name="pluginConfig">Plugin config</param>
        public static void InitializePlugins(this IApplicationPartManager applicationPartManager, PluginConfig pluginConfig)
        {
