...
namespace ARWNI2S.Runtime.Hosting
{
    ...
    public sealed class DefaultEngineContext : EngineContext
    {
        ...
        private static readonly Func<DefaultEngineContext, IServiceProvidersFeature> _newServiceProvidersFeature = context => new RequestServicesFeature(context, context.ServiceScopeFactory);
        private static readonly Func<IFeatureCollection, IAuthenticationFeature> _newAuthenticationFeature = f => new AuthenticationFeature();
        private static readonly Func<IFeatureCollection, IRequestLifetimeFeature> _newRequestLifetimeFeature = f => new RequestLifetimeFeature();
        ...
        private static readonly Func<IFeatureCollection, IRequestIdentifierFeature> _newRequestIdentifierFeature = f => new RequestIdentifierFeature();

        private FeatureReferences<FeatureInterfaces> _features;

        private readonly DefaultMessage _request;
        ...
        /// <inheritdoc/>
        public override IMessage Request => _request;

        /// <inheritdoc/>
        public override IMessage Response => _response;
        ...
        {
            throw new ObjectDisposedException(nameof(EngineContext), $"Request has finished and {nameof(EngineContext)} disposed.");
        }
