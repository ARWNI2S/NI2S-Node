...
using ARWNI2S.Node.Infrastructure.Threading;
...
namespace ARWNI2S.Node.Infrastructure
{
    ...
    public partial class CommonHelper
    {
        ...
        private static partial Regex TcwEmailRegex();
        ...
        static CommonHelper() => _emailRegex = TcwEmailRegex();
        ...
        /// <summary>
        /// Ensures the email or throw.
        /// </summary>
        /// <param name="email">The email.</param>
        /// <returns></returns>
        public static string EnsureEmailOrThrow(string email)
        {
            ...
            if (!IsValidEmail(output))
                throw new NiisException("Email is not valid.");
        ...
        public static void SetProperty(object instance, string propertyName, object value)
        {
            ...
            var pi = instanceType.GetProperty(propertyName) ?? throw new NiisException("No property '{0}' found on the instance of type '{1}'.", propertyName, instanceType);
            if (!pi.CanWrite)
                throw new NiisException("The property '{0}' on the instance of type '{1}' does not have a setter.", propertyName, instanceType);
...
#pragma warning disable CA1862 // Use las sobrecargas del método "StringComparison" para realizar comparaciones de cadenas sin distinción de mayúsculas y minúsculas
                if (ch.ToString() != ch.ToString().ToLowerInvariant())
                    result += " " + ch.ToString();
                else
                    result += ch.ToString();
#pragma warning restore CA1862 // Use las sobrecargas del método "StringComparison" para realizar comparaciones de cadenas sin distinción de mayúsculas y minúsculas
        ...
        /// <returns>An instance of the <see cref="Nullable{DateTime}"/></returns>
        ...
        /// </summary>
        public static IEngineFileProvider DefaultFileProvider { get; set; } = default!;
