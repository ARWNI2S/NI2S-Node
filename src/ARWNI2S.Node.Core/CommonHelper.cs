    ...
    public partial class CommonHelper
    {
        ...
        public static string EnsureSubscriberEmailOrThrow(string email)
        {
            ...
            if (!IsValidEmail(output))
                throw new ServerException("Email is not valid.");
        ...
        public static void SetProperty(object instance, string propertyName, object value)
        {
            ...
            var pi = instanceType.GetProperty(propertyName) ?? throw new ServerException("No property '{0}' found on the instance of type '{1}'.", propertyName, instanceType);
            if (!pi.CanWrite)
                throw new ServerException("The property '{0}' on the instance of type '{1}' does not have a setter.", propertyName, instanceType);
