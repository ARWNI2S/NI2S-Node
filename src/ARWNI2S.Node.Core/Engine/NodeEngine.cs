...
using ARWNI2S.Node.Infrastructure.Mapper;
using AutoMapper;
...
namespace ARWNI2S.Node.Engine
{
    ...
    public partial class NodeEngine : IEngine
    {
        ...
        protected virtual IServiceProvider GetServiceProvider(IServiceScope scope = null)
        {
            if (scope == null)
            {
                var accessor = ServiceProvider?.GetService<IScopedContextAccessor>();
        ...
        public virtual object ResolveUnregistered(Type type)
        {
            ...
            foreach (var constructor in type.GetConstructors())
            {
                try
                {
                    ...
                    {
                        var service = Resolve(parameter.ParameterType) ?? throw new NiisException("Unknown dependency");
                        return service;
                    });
            ...
            throw new NiisException("No constructor was found that had all the dependencies satisfied.", innerException);
        }
        ...
        /// Engine modules
        /// </summary>
        public virtual IEngineModules Modules { get; protected set; }
