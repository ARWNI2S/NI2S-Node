...
namespace ARWNI2S.Engine.Security
{
    ...
    public partial class AclService : IAclService
    {
        ...
        /// </returns>
        public virtual async Task<int[]> GetUserRoleIdsWithAccessAsync<TEntity>(TEntity entity) where TEntity : DataEntity, IAclSupported
        {
            ArgumentNullException.ThrowIfNull(entity);
        ...
        {
            return await AuthorizeAsync(entity, await _userService.GetUserByClaimsAsync(await _workContext.GetCurrentIdentityAsync()));
        }
