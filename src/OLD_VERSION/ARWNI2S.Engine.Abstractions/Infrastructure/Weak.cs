...
{
    /// <summary>
    /// Constants used by the generic <see cref="Weak{K, T}"/> class.
    /// </summary>
    ...
    internal sealed class Weak<TKey, TValue> : IDisposable
        ...
        where TValue : class
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Weak{K, T}"/> class.
        /// </summary>
        /// <param name="initialSize">The initial size of the interner mapping.</param>
        public Weak(int initialSize = InternerConstants.SIZE_SMALL)
        {
