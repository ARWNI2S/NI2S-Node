namespace ARWNI2S.Engine.Serialization
{
    //    /// <summary>
    ...
    //    /// </summary>
    //    /// <remarks>
    //    /// Every serializable member in a type which has <see cref="GenerateSerializerAttribute"/> applied to it must have one <see cref="IdAttribute"/> attribute applied with a unique <see cref="Id"/> value.
    //    /// </remarks>
    //    /// <seealso cref="Attribute" />
    //    [AttributeUsage(
