...
namespace ARWNI2S.Node.Data
{
    ...
    public partial class DataSettingsManager
    {
        ...
        /// <returns>Data settings</returns>
        public static DataConfig LoadSettings(IEngineFileProvider fileProvider = null, bool reload = false)
        {
            ...
            {
                Singleton<DataConfig>.Instance = Singleton<NiisSettings>.Instance.Get<DataConfig>();
            }
