...
namespace ARWNI2S.Node.Data.Migrations
{
    ...
    /// </summary>
    public partial class ServerMigrationAttribute : MigrationAttribute
    {
        #region Utils

        protected static long GetVersion(string dateTime)
        {
            return DateTime.ParseExact(dateTime, ServerMigrationDefaults.DateFormats, CultureInfo.InvariantCulture).Ticks;
        }
        ...
        {
            return string.Format(ServerMigrationDefaults.UpdateMigrationDescription, ni2sVersion, migrationType.ToString());
        }
        ...
        public ServerMigrationAttribute(string dateTime, MigrationProcessType targetMigrationProcess = MigrationProcessType.NoMatter) :
        ...
        /// <param name="targetMigrationProcess">The target migration process</param>
        public ServerMigrationAttribute(string dateTime, string description, MigrationProcessType targetMigrationProcess = MigrationProcessType.NoMatter) :
        ...
        /// <param name="targetMigrationProcess">The target migration process</param>
        public ServerMigrationAttribute(string dateTime, string ni2sVersion, UpdateMigrationType migrationType, MigrationProcessType targetMigrationProcess = MigrationProcessType.NoMatter) :
