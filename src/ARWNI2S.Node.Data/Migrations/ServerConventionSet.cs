...
namespace ARWNI2S.Node.Data.Migrations
{
    ...
    /// </summary>
    public class ServerConventionSet : IConventionSet
    {
        #region Ctor

        public ServerConventionSet(IServerDataProvider dataProvider)
        {
            ...
            [
                new ServerForeignKeyConvention(dataProvider),
                defaultConventionSet.SchemaConvention,
            ];

            IndexConventions =
            [
                new ServerIndexConvention(dataProvider),
                defaultConventionSet.SchemaConvention
            ];

            ColumnsConventions =
            [
                new ServerColumnsConvention(),
