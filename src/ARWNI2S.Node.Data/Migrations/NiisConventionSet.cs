...
namespace ARWNI2S.Node.Data.Migrations
{
    ...
    /// </summary>
    public class NiisConventionSet : IConventionSet
    {
        #region Ctor

        public NiisConventionSet(INiisDataProvider dataProvider)
        {
            ...
            [
                new NiisForeignKeyConvention(dataProvider),
                defaultConventionSet.SchemaConvention,
            ];

            IndexConventions =
            [
                new NiisIndexConvention(dataProvider),
                defaultConventionSet.SchemaConvention
            ];

            ColumnsConventions =
            [
                new NiisColumnsConvention(),
