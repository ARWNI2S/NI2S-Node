...
namespace ARWNI2S.Node.Data.DataProviders
{
    public partial class PostgreSqlServerDataProvider : BaseDataProvider, IServerDataProvider
    {
        ...
        protected virtual string GetSequenceName<TEntity>(DataConnection dataConnection) where TEntity : BaseDataEntity
        {
        ...
        public virtual async Task SetTableIdentAsync<TEntity>(int ident) where TEntity : BaseDataEntity
        {
