...
namespace ARWNI2S.Node.Data.DataProviders
{
    public abstract partial class BaseDataProvider
    {
        ...
        public virtual IQueryable<TEntity> GetTable<TEntity>() where TEntity : BaseDataEntity
        {
        ...
        /// </returns>
        public virtual async Task<TEntity> InsertEntityAsync<TEntity>(TEntity entity) where TEntity : BaseDataEntity
        {
        ...
        public virtual TEntity InsertEntity<TEntity>(TEntity entity) where TEntity : BaseDataEntity
        {
            using var dataContext = CreateDataConnection();
        ...
        public virtual async Task UpdateEntityAsync<TEntity>(TEntity entity) where TEntity : BaseDataEntity
        {
            using var dataContext = CreateDataConnection();
        ...
        /// <param name="entity">Entity with data to update</param>
        /// <typeparam name="TEntity">Entity type</typeparam>
        public virtual void UpdateEntity<TEntity>(TEntity entity) where TEntity : BaseDataEntity
        {
            using var dataContext = CreateDataConnection();
        ...
        /// <typeparam name="TEntity">Entity type</typeparam>
        /// <returns>A task that represents the asynchronous operation</returns>
        public virtual async Task UpdateEntitiesAsync<TEntity>(IEnumerable<TEntity> entities) where TEntity : BaseDataEntity
        {
        ...
        /// <param name="entities">Entities with data to update</param>
        /// <typeparam name="TEntity">Entity type</typeparam>
        public virtual void UpdateEntities<TEntity>(IEnumerable<TEntity> entities) where TEntity : BaseDataEntity
        {
            //we don't use the Merge API on this level, because this API not support all databases.
            //you may see all supported databases by the following link: https://linq2db.github.io/articles/sql/merge/Merge-API.html#supported-databases
            foreach (var entity in entities)
        ...
        /// <typeparam name="TEntity">Entity type</typeparam>
        /// <returns>A task that represents the asynchronous operation</returns>
        public virtual async Task DeleteEntityAsync<TEntity>(TEntity entity) where TEntity : BaseDataEntity
        {
            using var dataContext = CreateDataConnection();
        ...
        /// <param name="entity">Entity for delete operation</param>
        /// <typeparam name="TEntity">Entity type</typeparam>
        public virtual void DeleteEntity<TEntity>(TEntity entity) where TEntity : BaseDataEntity
        {
            using var dataContext = CreateDataConnection();
        ...
        /// <typeparam name="TEntity">Entity type</typeparam>
        /// <returns>A task that represents the asynchronous operation</returns>
        public virtual async Task BulkDeleteEntitiesAsync<TEntity>(IList<TEntity> entities) where TEntity : BaseDataEntity
        {
            using var dataContext = CreateDataConnection();
        ...
        /// <param name="entities">Entities for delete operation</param>
        /// <typeparam name="TEntity">Entity type</typeparam>
        public virtual void BulkDeleteEntities<TEntity>(IList<TEntity> entities) where TEntity : BaseDataEntity
        {
            using var dataContext = CreateDataConnection();
            if (entities.All(entity => entity.Id == 0))
                foreach (var entity in entities)
        ...
        /// </returns>
        public virtual async Task<int> BulkDeleteEntitiesAsync<TEntity>(Expression<Func<TEntity, bool>> predicate) where TEntity : BaseDataEntity
        {
            using var dataContext = CreateDataConnection();
        ...
        /// </returns>
        public virtual int BulkDeleteEntities<TEntity>(Expression<Func<TEntity, bool>> predicate) where TEntity : BaseDataEntity
        {
            using var dataContext = CreateDataConnection();
        ...
        /// <typeparam name="TEntity">Entity type</typeparam>
        /// <returns>A task that represents the asynchronous operation</returns>
        public virtual async Task BulkInsertEntitiesAsync<TEntity>(IEnumerable<TEntity> entities) where TEntity : BaseDataEntity
        {
        ...
        /// <param name="entities">Entities for insert operation</param>
        /// <typeparam name="TEntity">Entity type</typeparam>
        public virtual void BulkInsertEntities<TEntity>(IEnumerable<TEntity> entities) where TEntity : BaseDataEntity
        {
            using var dataContext = CreateDataConnection(LinqToDbDataProvider);
        ...
        /// <typeparam name="TEntity">Entity type</typeparam>
        public virtual async Task TruncateAsync<TEntity>(bool resetIdentity = false) where TEntity : BaseDataEntity
        {
            using var dataContext = CreateDataConnection(LinqToDbDataProvider);
