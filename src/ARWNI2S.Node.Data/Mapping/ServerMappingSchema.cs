...
namespace ARWNI2S.Node.Data.Mapping
{
    ...
    /// </summary>
    public static class NodeMappingSchema
    {
        #region Fields

        private static ConcurrentDictionary<Type, ServerEntityDescriptor> EntityDescriptors { get; } = new();
        ...
        public static ServerEntityDescriptor GetEntityDescriptor(Type entityType)
        {
            ...
            return EntityDescriptors.GetOrAdd(entityType, t =>
            {
                ...
                return new ServerEntityDescriptor
                {
                    EntityName = tableName,
                    SchemaName = builder.Expression.SchemaName,
                    Fields = builder.Expression.Columns.Select(column => new ServerEntityFieldDescriptor
                    {
                        Name = column.Name,
