    ...
    public partial class ModuleDescriptor : ModuleDescriptorBaseInfo, IDescriptor, IComparable<ModuleDescriptor>
    {
        ...
        public virtual void Save()
        {
            ...
            if (OriginalAssemblyFile == null)
                throw new ServerException($"Cannot load original assembly path for {SystemName} module.");
            ...
            if (!fileProvider.FileExists(filePath))
                throw new ServerException($"Description file for {SystemName} module does not exist. {filePath}");
