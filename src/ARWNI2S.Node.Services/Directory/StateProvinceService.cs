...
namespace ARWNI2S.Node.Data.Services.Directory
{
    ...
    public partial class StateProvinceService : IStateProvinceService
    {
        ...
        public virtual async Task<StateProvince> GetStateProvinceByAbbreviationAsync(string abbreviation, int? countryId = null)
        {
            ...
            var key = _staticCacheManager.PrepareKeyForDefaultCache(DirectoryServicesDefaults.StateProvincesByAbbreviationCacheKey
        ...
        {
            var key = _staticCacheManager.PrepareKeyForDefaultCache(DirectoryServicesDefaults.StateProvincesByCountryCacheKey, countryId, languageId, showHidden);
        ...
        public virtual async Task<IList<StateProvince>> GetStateProvincesAsync(bool showHidden = false)
        {
            ...
            var stateProvinces = await _staticCacheManager.GetAsync(_staticCacheManager.PrepareKeyForDefaultCache(DirectoryServicesDefaults.StateProvincesAllCacheKey, showHidden), async () => await query.ToListAsync());
