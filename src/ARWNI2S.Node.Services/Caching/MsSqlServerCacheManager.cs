...
namespace ARWNI2S.Node.Services.Caching
{
    ...
    public class MsSqlServerCacheManager : DistributedCacheManager
    {
        ...
        public MsSqlServerCacheManager(NiisSettings niisSettings,
            IDistributedCache distributedCache,
            ICacheKeyManager cacheKeyManager,
            IConcurrentCollection<object> concurrentCollection)
            : base(niisSettings, distributedCache, cacheKeyManager, concurrentCollection)
        {
            _distributedCacheConfig = niisSettings.Get<DistributedCacheConfig>();
        }
