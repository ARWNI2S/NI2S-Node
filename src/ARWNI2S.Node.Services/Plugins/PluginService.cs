...
namespace ARWNI2S.Node.Services.Plugins
{
    ...
    public partial class PluginService : IPluginService
    {
        ...
        /// </returns>
        protected virtual async Task<bool> FilterByUserAsync(PluginDescriptor pluginDescriptor, IUser user)
        {
            ArgumentNullException.ThrowIfNull(pluginDescriptor);
        ...
        public virtual async Task<IList<PluginDescriptor>> GetPluginDescriptorsAsync<TPlugin>(LoadPluginsMode loadMode = LoadPluginsMode.InstalledOnly,
            IUser user = null, int nodeId = 0, string group = null, string dependsOnSystemName = "", string friendlyName = null, string author = null) where TPlugin : class, IPlugin
        {
        ...
        public virtual async Task<PluginDescriptor> GetPluginDescriptorBySystemNameAsync<TPlugin>(string systemName,
            ...
            IUser user = null, int nodeId = 0, string @group = null) where TPlugin : class, IPlugin
        {
        ...
        public virtual async Task PreparePluginToInstallAsync(string systemName, IUser user = null, bool checkDependencies = true)
        {
