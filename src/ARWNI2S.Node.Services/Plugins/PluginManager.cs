...
namespace ARWNI2S.Node.Services.Plugins
{
    ...
    public partial class PluginManager<TPlugin> : IPluginManager<TPlugin> where TPlugin : class, IPlugin
    {
        ...
        /// </returns>
        protected virtual async Task<TPlugin> LoadPrimaryPluginAsync(string systemName, IUser user = null, int nodeId = 0)
        {
        ...
        /// </returns>
        public virtual async Task<IList<TPlugin>> LoadAllPluginsAsync(IUser user = null, int nodeId = 0)
        {
        ...
        /// The task result contains the plugin
        /// </returns>
        public virtual async Task<TPlugin> LoadPluginBySystemNameAsync(string systemName, IUser user = null, int nodeId = 0)
        {
        ...
        /// </returns>
        public virtual async Task<IList<TPlugin>> LoadActivePluginsAsync(List<string> systemNames, IUser user = null, int nodeId = 0)
        {
            if (systemNames == null)
                return [];
