...
namespace ARWNI2S.Node.Services.Plugins
{
    ...
    public partial interface IPluginManager<TPlugin> where TPlugin : class, IPlugin
    {
        ...
        /// </returns>
        Task<IList<TPlugin>> LoadAllPluginsAsync(User user = null, int nodeId = 0);
        ...
        /// </returns>
        Task<TPlugin> LoadPluginBySystemNameAsync(string systemName, User user = null, int nodeId = 0);
        ...
        /// </returns>
        Task<IList<TPlugin>> LoadActivePluginsAsync(List<string> systemNames, User user = null, int nodeId = 0);
