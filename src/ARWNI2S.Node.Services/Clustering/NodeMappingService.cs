...
namespace ARWNI2S.Node.Services.Clustering
{
    ...
    public partial class NodeMappingService : INodeMappingService
    {
        ...
        /// </returns>
        protected virtual async Task<bool> IsEntityMappingExistsAsync<TEntity>() where TEntity : DataEntity, ISupportNodeMapping
        {
        ...
        public virtual async Task<IQueryable<TEntity>> ApplyNodeMapping<TEntity>(IQueryable<TEntity> query, int nodeId)
            where TEntity : DataEntity, ISupportNodeMapping
        {
        ...
        /// </returns>
        public virtual async Task<IList<NodeMapping>> GetNodeMappingsAsync<TEntity>(TEntity entity) where TEntity : DataEntity, ISupportNodeMapping
        {
        ...
        /// <returns>A task that represents the asynchronous operation</returns>
        public virtual async Task InsertNodeMappingAsync<TEntity>(TEntity entity, int nodeId) where TEntity : DataEntity, ISupportNodeMapping
        {
            ArgumentNullException.ThrowIfNull(entity);
        ...
        /// </returns>
        public virtual async Task<int[]> GetNodesIdsWithAccessAsync<TEntity>(TEntity entity) where TEntity : DataEntity, ISupportNodeMapping
        {
            ArgumentNullException.ThrowIfNull(entity);
        ...
        /// </returns>
        public virtual int[] GetNodesIdsWithAccess<TEntity>(TEntity entity) where TEntity : DataEntity, ISupportNodeMapping
        {
            ArgumentNullException.ThrowIfNull(entity);
        ...
        /// </returns>
        public virtual async Task<bool> AuthorizeAsync<TEntity>(TEntity entity) where TEntity : DataEntity, ISupportNodeMapping
        {
        ...
        /// The task result contains the rue - authorized; otherwise, false
        /// </returns>
        public virtual async Task<bool> AuthorizeAsync<TEntity>(TEntity entity, int nodeId) where TEntity : DataEntity, ISupportNodeMapping
        {
            if (entity == null)
                return false;
        ...
        /// </returns>
        public virtual bool Authorize<TEntity>(TEntity entity, int nodeId) where TEntity : DataEntity, ISupportNodeMapping
        {
            if (entity == null)
                return false;
