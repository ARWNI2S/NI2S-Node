...
{
    /// <summary>
    /// Configuration loader for Clustering.
    /// </summary>
    public class ClusteringConfigurationLoader
    {
        ...
        internal ClusteringConfigurationLoader(
            ClusteringServerOptions options,
        ...
        /// <summary>
        /// Gets the <see cref="ClusteringServerOptions"/>.
        /// </summary>
        public ClusteringServerOptions Options { get; }
        ...
        /// This will only reload endpoints defined in the "Endpoints" section of your Clustering configuration. Endpoints defined in code will not be reloaded.
        /// </summary>
        ...
        ///// </summary>
        //public ClusteringConfigurationLoader Endpoint(string name, Action<EndpointConfiguration> configureOptions)
        //{
        ...
        ///// </summary>
        //public ClusteringConfigurationLoader Endpoint(IPAddress address, int port) => Endpoint(address, port, _ => { });

        ///// <summary>
        ///// Bind to given IP address and port.
        ///// </summary>
        //public ClusteringConfigurationLoader Endpoint(IPAddress address, int port, Action<ListenOptions> configure)
        //{
        ...
        ///// </summary>
        //public ClusteringConfigurationLoader Endpoint(IPEndPoint endPoint) => Endpoint(endPoint, _ => { });

        ///// <summary>
        ///// Bind to given IP address and port.
        ///// </summary>
        //public ClusteringConfigurationLoader Endpoint(IPEndPoint endPoint, Action<ListenOptions> configure)
        //{
        ...
        ///// </summary>
        //public ClusteringConfigurationLoader LocalhostEndpoint(int port) => LocalhostEndpoint(port, options => { });

        ///// <summary>
        ///// Listens on ::1 and 127.0.0.1 with the given port. Requesting a dynamic port by specifying 0 is not supported
        ///// for this type of endpoint.
        ///// </summary>
        //public ClusteringConfigurationLoader LocalhostEndpoint(int port, Action<ListenOptions> configure)
        //{
        //    ArgumentNullException.ThrowIfNull(configure);
        ...
        ///// </summary>
        //public ClusteringConfigurationLoader AnyIPEndpoint(int port) => AnyIPEndpoint(port, options => { });

        ///// <summary>
        ///// Listens on all IPs using IPv6 [::], or IPv4 0.0.0.0 if IPv6 is not supported.
        ///// </summary>
        //public ClusteringConfigurationLoader AnyIPEndpoint(int port, Action<ListenOptions> configure)
        //{
        //    ArgumentNullException.ThrowIfNull(configure);
        ...
        ///// </summary>
        //public ClusteringConfigurationLoader UnixSocketEndpoint(string socketPath) => UnixSocketEndpoint(socketPath, _ => { });

        ///// <summary>
        ///// Bind to given Unix domain socket path.
        ///// </summary>
        //public ClusteringConfigurationLoader UnixSocketEndpoint(string socketPath, Action<ListenOptions> configure)
        //{
        ...
        ///// </summary>
        //public ClusteringConfigurationLoader NamedPipeEndpoint(string pipeName) => NamedPipeEndpoint(pipeName, _ => { });

        ///// <summary>
        ///// Bind to given named pipe.
        ///// </summary>
        //public ClusteringConfigurationLoader NamedPipeEndpoint(string pipeName, Action<ListenOptions> configure)
        //{
        ...
        ///// </summary>
        //public ClusteringConfigurationLoader HandleEndpoint(ulong handle) => HandleEndpoint(handle, _ => { });

        ///// <summary>
        ///// Open a socket file descriptor.
        ///// </summary>
        //public ClusteringConfigurationLoader HandleEndpoint(ulong handle, Action<ListenOptions> configure)
        //{
        //    ArgumentNullException.ThrowIfNull(configure);
        ...
        //// Called from ClusteringServerOptions.ApplyEndpointDefaults so it applies to even explicit Listen endpoints.
        ...
        //// Called from ClusteringServerOptions.ApplyHttpsDefaults so it applies to even explicit Listen endpoints.
        //// Does not require a call to Load.
        ...
        //// Adds endpoints from config to ClusteringServerOptions.ConfigurationBackedListenOptions and configures some other options.
