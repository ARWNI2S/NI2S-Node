...
namespace NI2S.Node.Core.Infrastructure
{
    ...
    /// </summary>
    public interface INodeFileProvider : IFileProvider
    {
        /// <summary>
        ...
        /// <returns>
        /// A <see cref="DateTime"/> structure set to the creation date and time for the specified file or directory. This value
        ...
        /// <param name="searchPattern">
        /// The search string to match against the names of subdirectories in path. This parameter can contain a combination of valid literal
        /// and wildcard characters, but doesn't support regular expressions.
        /// </param>
        /// <param name="topDirectoryOnly">
        /// Specifies whether to search the current directory, or the current directory and all subdirectories.
        /// </param>
        /// <returns>
        /// An array of the full names (including paths) of the subdirectories that match the specified criteria, or an empty array if no 
        ...
        /// <see cref="String.Empty"/> if path does not contain directory information.
        /// </returns>
        ...
        /// of valid literal path and wildcard (* and ?) characters, but doesn't support regular expressions.
        /// </param>
        /// <param name="topDirectoryOnly">
        /// Specifies whether to search the current directory, or the current directory and all subdirectories.
        /// </param>
        ...
        /// specified search pattern, or an empty array if no files are found.
        /// </returns>
        ...
        /// <returns>
        /// A <see cref="DateTime"/> structure set to the date and time that the specified file or directory was
        ...
        /// <param name="path">The file or directory for which to obtain write date and time information.</param>
        /// <returns>
        /// A System.DateTime structure set to the date and time that the specified file or directory was last
        ...
        /// <returns>The physical path. E.g. "c:\arwniis\world\bin".</returns>
        ...
        /// <returns>
        /// A <see cref="Task{byte[]}"/>task that represents the asynchronous operation. The task result contains a <see cref="byte"/>
        ...
        /// <returns>
        /// A <see cref="Task{string}"/> that represents the asynchronous operation. The task result contains
        ...
        /// <summary>
        /// Gets the absolute path to the directory that contains the narrative simulation asset content files.
        /// </summary>
