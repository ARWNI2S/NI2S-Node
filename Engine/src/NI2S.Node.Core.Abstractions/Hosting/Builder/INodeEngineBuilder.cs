...
namespace NI2S.Node.Hosting.Builder
{
    ...
    /// </summary>
    public interface INodeEngineBuilder
    {
        /// <summary>
        ...
        /// <summary>
        /// Creates a new <see cref="INodeEngineBuilder"/> that shares the <see cref="Properties"/> of this
        /// <see cref="INodeEngineBuilder"/>.
        /// </summary>
        /// <returns>The new <see cref="INodeEngineBuilder"/>.</returns>
        INodeEngineBuilder New();
