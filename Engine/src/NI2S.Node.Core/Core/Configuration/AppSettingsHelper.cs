...
namespace NI2S.Node.Core.Configuration
{
    ...
    public partial class AppSettingsHelper
    {
        ...
        public static AppSettings SaveAppSettings(IList<IConfig> configurations, INI2SFileProvider fileProvider, bool overwrite = true)
        {
            ...
            var filePath = fileProvider.MapPath(NodeConfigurationDefaults.AppSettingsFilePath);
