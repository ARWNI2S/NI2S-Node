...
namespace NI2S.Node.Core.Infrastructure
{
    ...
    /// </summary>
    public partial class NodeFileProvider : PhysicalFileProvider, INodeFileProvider
    {
        ...
        /// <inheritdoc/>
        public string AssetsPath => Path.Combine(NodeRootPath, Constants.AssetsDirectoryName);
