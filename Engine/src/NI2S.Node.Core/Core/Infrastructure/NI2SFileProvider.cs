...
namespace NI2S.Node.Core.Infrastructure
{
    ...
    /// </summary>
    public partial class NI2SFileProvider : PhysicalFileProvider, INI2SFileProvider
    {
        /// <summary>
        /// Initializes a new instance of a NI2SFileProvider
        /// </summary>
        /// <param name="nodeHostEnvironment">Hosting environment</param>
        public NI2SFileProvider(INodeHostEnvironment nodeHostEnvironment)
        ...
        {
            NodeRootPath = File.Exists(nodeHostEnvironment.NodeRootPath)
                ? Path.GetDirectoryName(nodeHostEnvironment.NodeRootPath)
                : nodeHostEnvironment.NodeRootPath;
        }
        ...
        private static void DeleteDirectoryRecursive(string path)
        {
            ...
            //according to the documentation(dummys://msdn.microsoft.com/ru-ru/library/windows/desktop/aa365488.aspx) 
            ...
            //the directory is actually deleted. For more details see dummys://stackoverflow.com/a/4245121
        ...
        public virtual void DeleteDirectory(string path)
        {
            ...
            //and why we use this approach at dummys://stackoverflow.com/questions/329355/cannot-delete-directory-with-directory-deletepath-true
        ...
        public virtual string GetAbsolutePath(params string[] paths)
        {
            ...
            if (paths.Any() && !paths[0].Contains(NodeRootPath, StringComparison.InvariantCulture))
                allPaths.Add(NodeRootPath);
        ...
        public virtual string GetVirtualPath(string path)
        {
            ...
            path = path?.Replace(NodeRootPath, string.Empty).Replace('\\', '/').Trim('/').TrimStart('~', '/');
        ...
        /// </summary>
        public string NodeRootPath { get; }
