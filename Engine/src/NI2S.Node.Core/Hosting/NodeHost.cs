...
namespace NI2S.Node.Hosting
{
    ...
    public static class NodeHost
    {
        ...
        /// <param name="app">A delegate that handles requests to the application.</param>
        /// <returns>A started <see cref="INodeHost"/> that hosts the application.</returns>
        public static INodeHost Start([StringSyntax(StringSyntaxAttribute.Uri)] string url, RequestDelegate app)
        {
            ...
            return StartWith(app: appBuilder => appBuilder.Run(app));
        }
        ...
        /// <param name="app">The delegate that configures the <see cref="IEngineBuilder"/>.</param>
        /// <returns>A started <see cref="INodeHost"/> that hosts the application.</returns>
        public static INodeHost StartWith([StringSyntax(StringSyntaxAttribute.Uri)] string url, Action<IEngineBuilder> app) =>
        ...
        ///     adds the ForwardedHeaders middleware if DOTNET_FORWARDEDHEADERS_ENABLED=true,
        ...
        internal static void ConfigureNodeDefaults(INodeHostBuilder builder)
        {
            ...
            //ConfigureNodeDefaultsCore(builder, services =>
            //{
            //    services.AddRouting();
            //});
        ...
        internal static void ConfigureNodeDefaultsCore(INodeHostBuilder builder, Action<IServiceCollection> configureRouting = null)
        {
