...
namespace NI2S.Node.Hosting
{
    ...
    public sealed class NodeEngine : IHost, IEngineBuilder, IClusterNodeBuilder, IAsyncDisposable
    {
        ...
        /// </summary>
        //public ICollection<string> Urls => EngineModules.GetRequiredFeature<IServerAddressesFeature>().Addresses;
        ...
        /// Initializes a new instance of the <see cref="NodeEngineBuilder"/> class with preconfigured defaults.
        /// </summary>
        /// <param name="options">The <see cref="WebApplicationOptions"/> to configure the <see cref="NodeEngineBuilder"/>.</param>
        /// <returns>The <see cref="NodeEngineBuilder"/>.</returns>
        ...
        INodeEngine IEngineBuilder.Build() => BuildNodeEngine();
