...
namespace NI2S.Node.Hosting
{
    ...
    internal sealed class HostingRequestFinishedLog : IReadOnlyList<KeyValuePair<string, object>>
    {
        ...
        private readonly HostingEngine.Context _context;
        ...
        public HostingRequestFinishedLog(HostingEngine.Context context, TimeSpan elapsed)
        {
            _context = context;
            Elapsed = elapsed;
        }
        ...
        public override string ToString()
        {
            ...
            {
                Debug.Assert(_context.DummyContext != null && _context.StartLog != null);
