...
namespace NI2S.Node.Dummy
{
    ...
    public readonly struct PathString : IEquatable<PathString>
    {
        ...
        public static PathString FromUriComponent(string uriComponent)
        {
            ...
            var length = 0; // UrlDecoder.DecodeInPlace(pathBuffer.Slice(position, uriComponent.Length - position));
        ...
        public static PathString FromUriComponent(Uri uri)
        {
            ...
            pathBuffer[0] = '/';
            var length = 0; // UrlDecoder.DecodeRequestLine(uriComponent.AsSpan(), pathBuffer.Slice(1));
