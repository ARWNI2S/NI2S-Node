...
namespace NI2S.Node.Dummy
{
    ...
    public abstract class DummyContext
    {
        ...
        /// <summary>
        /// Gets the <see cref="DummyRequest"/> object for this request.
        /// </summary>
        public abstract DummyRequest Request { get; }

        /// <summary>
        /// Gets the <see cref="DummyResponse"/> object for this request.
        /// </summary>
        public abstract DummyResponse Response { get; }
