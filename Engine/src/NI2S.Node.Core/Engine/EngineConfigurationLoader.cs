...
namespace NI2S.Node.Engine
{
    ...
    public class EngineConfigurationLoader
    {
        ...
        public EngineConfigurationLoader(EngineOptions options, IConfiguration configuration, IHostEnvironment hostEnvironment, bool reloadOnChange, ILogger logger, ILogger moduleLogger)
        {
            Options = options;
