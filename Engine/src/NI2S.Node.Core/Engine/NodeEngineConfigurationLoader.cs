...
using NI2S.Node.Engine.Internal;
using System;
...
{
    /// <summary>
    /// Configuration loader for node engine.
    /// </summary>
    public class NodeEngineConfigurationLoader
    {
        ...
        public NodeEngineConfigurationLoader(NodeEngineOptions options, IConfiguration configuration, IHostEnvironment hostEnvironment, bool reloadOnChange, ILogger logger, ILogger moduleLogger)
        {
            Options = options;
        ...
        /// <summary>
        /// Gets the <see cref="NodeEngineOptions"/>.
        /// </summary>
        public NodeEngineOptions Options { get; }
        ...
        /// </summary>
        //public NodeEngineConfigurationLoader Endpoint(string name, Action<EndpointConfiguration> configureOptions)
        //{
        ...
        /// </summary>
        //public NodeEngineConfigurationLoader Endpoint(IPAddress address, int port) => Endpoint(address, port, _ => { });

        /// <summary>
        /// Bind to given IP address and port.
        /// </summary>
        //public NodeEngineConfigurationLoader Endpoint(IPAddress address, int port, Action<ListenOptions> configure)
        //{
        ...
        /// </summary>
        //public NodeEngineConfigurationLoader Endpoint(IPEndPoint endPoint) => Endpoint(endPoint, _ => { });

        /// <summary>
        /// Bind to given IP address and port.
        /// </summary>
        //public NodeEngineConfigurationLoader Endpoint(IPEndPoint endPoint, Action<ListenOptions> configure)
        //{
        ...
        /// </summary>
        //public NodeEngineConfigurationLoader LocalhostEndpoint(int port) => LocalhostEndpoint(port, options => { });

        /// <summary>
        /// Listens on ::1 and 127.0.0.1 with the given port. Requesting a dynamic port by specifying 0 is not supported
        /// for this type of endpoint.
        /// </summary>
        //public NodeEngineConfigurationLoader LocalhostEndpoint(int port, Action<ListenOptions> configure)
        //{
        //    ArgumentNullException.ThrowIfNull(configure);
        ...
        /// </summary>
        //public NodeEngineConfigurationLoader AnyIPEndpoint(int port) => AnyIPEndpoint(port, options => { });

        /// <summary>
        /// Listens on all IPs using IPv6 [::], or IPv4 0.0.0.0 if IPv6 is not supported.
        /// </summary>
        //public NodeEngineConfigurationLoader AnyIPEndpoint(int port, Action<ListenOptions> configure)
        //{
        //    ArgumentNullException.ThrowIfNull(configure);
        ...
        /// </summary>
        //public NodeEngineConfigurationLoader UnixSocketEndpoint(string socketPath) => UnixSocketEndpoint(socketPath, _ => { });

        /// <summary>
        /// Bind to given Unix domain socket path.
        /// </summary>
        //public NodeEngineConfigurationLoader UnixSocketEndpoint(string socketPath, Action<ListenOptions> configure)
        //{
        ...
        /// </summary>
        //public NodeEngineConfigurationLoader HandleEndpoint(ulong handle) => HandleEndpoint(handle, _ => { });

        /// <summary>
        /// Open a socket file descriptor.
        /// </summary>
        //public NodeEngineConfigurationLoader HandleEndpoint(ulong handle, Action<ListenOptions> configure)
        //{
        //    ArgumentNullException.ThrowIfNull(configure);
        ...
        // Called from NodeEngineOptions.ApplyEndpointDefaults so it applies to even explicit Listen endpoints.
        ...
        // Called from NodeEngineOptions.ApplyHttpsDefaults so it applies to even explicit Listen endpoints.
        // Does not require a call to Load.
        ...
        // Adds endpoints from config to NodeEngineOptions.ConfigurationBackedListenOptions and configures some other options.
