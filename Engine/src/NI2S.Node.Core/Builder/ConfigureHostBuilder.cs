...
namespace NI2S.Node.Builder
{
    ...
    public sealed class ConfigureHostBuilder : IHostBuilder, ISupportsConfigureNodeHost
    {
        ...
        public IHostBuilder ConfigureHostConfiguration(Action<IConfigurationBuilder> configureDelegate)
        {
            ...
            {
                throw new NotSupportedException($"The content root changed from \"{previousContentRoot}\" to \"{HostingPathResolver.ResolvePath(_configuration[HostDefaults.ContentRootKey])}\". Changing the host configuration using NodeEngineBuilder.Host is not supported. Use NodeEngine.CreateBuilder(NodeEngineOptions) instead.");
            }
