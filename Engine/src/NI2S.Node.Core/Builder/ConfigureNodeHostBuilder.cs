    ...
    public sealed class ConfigureNodeHostBuilder : INodeHostBuilder, ISupportsStartup
    {
        ...
        public INodeHostBuilder ConfigureAppConfiguration(Action<NodeHostBuilderContext, IConfigurationBuilder> configureDelegate)
        {
                ...
                && !string.Equals(HostingPathResolver.ResolvePath(previousNodeRoot, previousContentRoot), HostingPathResolver.ResolvePath(_configuration[NodeHostDefaults.NodeRootKey], previousContentRoot), StringComparison.OrdinalIgnoreCase))
            {
                ...
                throw new NotSupportedException($"The web root changed from \"{HostingPathResolver.ResolvePath(previousNodeRoot, previousContentRoot)}\" to \"{HostingPathResolver.ResolvePath(_configuration[NodeHostDefaults.NodeRootKey], previousContentRoot)}\". Changing the host configuration using NodeEngineBuilder.NodeHost is not supported. Use NodeEngine.CreateBuilder(NodeEngineOptions) instead.");
            }
        ...
        public INodeHostBuilder UseSetting(string key, string value)
        {
            ...
            {
                // Disallow changing any host configuration
                throw new NotSupportedException($"The web root changed from \"{HostingPathResolver.ResolvePath(previousNodeRoot, previousContentRoot)}\" to \"{HostingPathResolver.ResolvePath(value, previousContentRoot)}\". Changing the host configuration using NodeEngineBuilder.NodeHost is not supported. Use NodeEngine.CreateBuilder(NodeEngineOptions) instead.");
            }
