...
using NI2S.Node.Data.Configuration;
using System;
...
namespace NI2S.Node.Data
{
    ...
    public partial class DataSettingsManager
    {
        ...
        /// <returns>Data settings</returns>
        public static DataConfig LoadSettings(INI2SFileProvider fileProvider = null, bool reload = false)
        {
            ...
            var filePath_json = fileProvider.MapPath(NI2SDataSettingsDefaults.FilePath);
            var filePath_txt = fileProvider.MapPath(NI2SDataSettingsDefaults.ObsoleteFilePath);
        ...
        /// <param name="fileProvider">File provider</param>
        public static void SaveSettings(DataConfig dataSettings, INI2SFileProvider fileProvider)
        {
            AppSettingsHelper.SaveAppSettings(new List<IConfig> { dataSettings }, fileProvider);
