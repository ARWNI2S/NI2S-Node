...
namespace NI2S.Node.Analyzers
{
    ...
    public class EntityInterfaceMethodReturnTypeDiagnosticAnalyzer : DiagnosticAnalyzer
    {
        ...
        public const string DiagnosticId = "NI2S0009";
        public const string Title = "Entity interfaces methods must return a compatible type";
        public const string MessageFormat = $"Entity interfaces methods must return a compatible type, such as Task, Task<T>, ValueTask, ValueTask<T>, or void";
